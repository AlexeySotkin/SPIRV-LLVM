; RUN: llvm-as < %s | llvm-spirv -spirv-text -o - -spirv-mem2reg=1 | FileCheck %s
...
entry:
  %call = call spir_func zeroext i1 @_Z30atomic_compare_exchange_strongPVU3AS4U7_AtomiciPU3AS4ii(i32 addrspace(4)* %object, i32 addrspace(4)* %expected, i32 %desired)
...
; CHECK-NOT: [[Result]]
  ...
  %call2 = call spir_func zeroext i1 @_Z28atomic_compare_exchange_weakPVU3AS4U7_AtomiciPU3AS4ii(i32 addrspace(4)* %object, i32 addrspace(4)* %expected, i32 %desired)
...
; CHECK-NOT: [[Result]]
  ...
  %tobool4 = trunc i8 %frombool3 to i1
