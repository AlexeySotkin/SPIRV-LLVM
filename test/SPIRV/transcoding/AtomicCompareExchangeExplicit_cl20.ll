...
;CHECK-SPIRV: Constant [[int]] [[DeviceScope:[0-9]+]] 1
;CHECK-SPIRV: Constant [[int]] [[ReleaseMemSem:[0-9]+]] 4
;CHECK-SPIRV: Constant [[int]] [[RelaxedMemSem:[0-9]+]] 0
;CHECK-SPIRV: Constant [[int]] [[WorkgroupScope:[0-9]+]] 2
;CHECK-SPIRV: Constant [[int]] [[AcqRelMemSem:[0-9]+]] 8
